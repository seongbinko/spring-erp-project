...
<div class="w3-sidebar w3-bar-block w3-blue-gray w3-card" style="width:200px;">
  <a href="#" class="w3-bar-item w3-button">재고 메뉴  <i class="fa fa-apple"></i></a>
  <button class="w3-button w3-block w3-left-align" onclick="myAccFunc()">
  	재고 조회 <i class="fa fa-caret-down"></i>
  </button>
  ...
  <button class="w3-button w3-block w3-left-align" onclick="myAccFunc2()">
  	재고 관리 <i class="fa fa-caret-down"></i>
  </button>
  <div id="demoAcc2" class="w3-hide w3-blue-gray w3-card">
  	<a href="requestProducts.erp" class="w3-bar-item w3-button w3-right-align">생산 의뢰</a>
    <a href="stockMove.erp" class="w3-bar-item w3-button w3-right-align">재고 이동</a>
  </div>
</div>
